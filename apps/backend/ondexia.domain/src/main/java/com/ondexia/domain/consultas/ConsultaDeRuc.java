 ...
 *
 * <p>No en el desplegable de la API: su Lambda está en subred privada sin NAT y
 * no tiene salida a internet (DTE §4.8). El adaptador real vive en
 * {@code ondexia.consultas}, fuera de la VPC, y la API valida su respuesta
 * mediante una atestación firmada — sin red (DT-19).
 */
