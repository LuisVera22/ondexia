...
import com.ondexia.api.comun.seguridad.ContextoInterceptor;
import com.ondexia.api.comun.seguridad.RequierePermiso;
...
class PermisosAnotacionIT extends PruebaIntegracion {
    ...
    void losPermisosDeclaradosExisten() {
        ...
        JavaClasses clases = new ClassFileImporter()
                ...
                .importPackages("com.ondexia.api");

        Set<String> enElCatalogo = permisos.findAll().stream()
                .map(com.ondexia.domain.identidad.Permiso::getCodigo)
