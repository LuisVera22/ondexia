 ...
 *
 * <h2>Es una copia de la de ondexia.api, y es deliberado</h2>
 *
 * <p>Compartirla exigiria un modulo de infraestructura comun, y crear uno para
 * ciento treinta lineas con dos consumidores es peor negocio que la copia: el
 * modulo compartido acaba siendo el sitio donde cae todo lo que no se sabe donde
 * poner, y entonces el panel vuelve a depender de piezas de la API de clientes
 * — que es justo lo que el doc 09 §6.1 evita.
 *
 * <p>Se extrae el dia que haya un tercer consumidor. Mientras tanto, si esta
 * clase cambia por un fallo, hay que cambiar las dos; el comentario esta aqui
 * para que quien lo lea lo sepa.
 *
