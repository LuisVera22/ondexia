package com.ondexia.api.identidad.web;

import com.ondexia.api.identidad.aplicacion.ContextoResuelto;
import com.ondexia.api.identidad.aplicacion.ServicioContexto;
...
public class ContextoController {
    ...
    public ContextoController(ServicioContexto servicio) {
    ...
    public RespuestaContexto consultar() {
        return RespuestaContexto.desde(servicio.resolver());
    }
