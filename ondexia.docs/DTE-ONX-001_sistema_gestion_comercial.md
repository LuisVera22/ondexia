...
| Verificación | **Implementado.** Módulo `apps/backend/ondexia.consultas` (sin Spring: su arranque en frío es de cientos de milisegundos y la consulta ocurre mientras alguien espera en un formulario) y `ondexia.infra/consultas.tf`, con 24 pruebas propias más 18 sobre la atestación. Falta la llamada real contra Decolecta: el mapeo de campos viene de su documentación |
